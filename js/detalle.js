...
//buscar la pelicula 
let listaPelicula = JSON.parse(localStorage.getItem('listaPelicula')) || [];
const peliBuscada = listaPelicula.find((pelicula) => pelicula.codigo === parametroCodigo.get('codigo'));
